...
public:
    Madgwick(void);
    void begin(float sampleFrequency, float beta) { invSampleFreq = 1.0f / sampleFrequency; this->beta = beta; }
    ...
    void getQuaternion(float& ow, float& ox, float& oy, float& oz) const {
        ow = q0; ox = q1; oy = q2; oz = q3;
    }
    void reset() {
